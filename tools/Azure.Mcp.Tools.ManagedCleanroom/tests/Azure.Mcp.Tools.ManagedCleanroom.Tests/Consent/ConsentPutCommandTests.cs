...
namespace Azure.Mcp.Tools.ManagedCleanroom.Tests.Consent;

public sealed class ConsentPutCommandTests : CommandUnitTestsBase<ConsentPutCommand, IManagedCleanroomServiceDataPlane>
{
