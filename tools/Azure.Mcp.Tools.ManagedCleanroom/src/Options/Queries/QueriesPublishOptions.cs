...
public class QueriesPublishOptions
{
    ...
    [Option(Description = "The unique identifier (UUID) of the query document to publish.")]
    public required string DocumentId { get; set; }

    [Option(Description = "JSON request body for query publish. Supports CLI-style @file input to load JSON from disk. Use @@ to send a literal value starting with '@'. If omitted, an empty JSON object '{}' is sent.")]
