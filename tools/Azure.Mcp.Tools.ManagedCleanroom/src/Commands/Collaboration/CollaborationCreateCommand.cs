...
[CommandMetadata(
    ...
    Description = """
        ...
        Returns immediately after the ARM resource is accepted — provisioning continues in the background
        and takes approximately 25 minutes. Poll provisioningState on the ARM resource to track completion.
        Required options:
